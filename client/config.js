...
const CHANGELOG = [
  "Credits:",
  "Updated 11/21/22",
  "This version is made by float#8692", ,
  "Check out the GitHub repository!: github.com/ABCxFF/diepcustom",
  "Join diepcustom Discord server: discord.gg/SyxWdxgHnT !",
  "Join MY Discord server! : https://discord.gg/Z2aZ22UKv5",
  "",
  "This is all possible because of DiepCustom!",
  "",
  "",
  "",
  "",
  ...
  "Changelog",
  "Updated 11/21/22",
  "Finally figured out how to change the backround on the main menu, thanks to ABC.",
  "Removed sniper, because I hate the sniper. And all of it's upgrades. I plan on",
  "changing permissions so that you cant auto level up in games that aren't ",
  "sandbox. Updated to the custom commands update. Implemented a theme menu.",
