...
server.listen(PORT, () => {
    ...
    const ffa = new Game_1.default(wss, "ffa", "Main");
    //only gamemode for now bcus of a glitch. @nulled smh
    const sbx = new Game_1.default(wss, "sbx", "Sandbox");
    const teams = new Game_1.default(wss, "teams", "Team");
    //const fourteams = new GameServer(wss, "fourteams", "4 Teams");
    const dom = new Game_1.default(wss, "dom", "Domination");
    //const mot = new GameServer(wss, "mot", "Mothership");
    //const bossrush = new GameServer(wss, "bossrush", "Boss Rush");
    //const testing = new GameServer(wss, "testing", "Testing");
    games.push(ffa, sbx, teams, dom);
    //games.push(ffa, sbx, teams, fourteams, dom, bossrush, testing, mot);
