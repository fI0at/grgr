...
class TankBody extends Live_1.default {
    ...
    onKill(entity) {
        ...
        if ((process['ALL_ENTITIES'] || entity instanceof Square_1.default) && this._currentTank === Enums_1.Tank.Necromancer && this.barrels.length && this.barrels[0].droneCount < (22 + this.cameraEntity.camera.values.statLevels.values[Enums_1.Stat.Reload] * 2)) {
